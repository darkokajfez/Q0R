...
csp=[0.6 0.6 0.6];
text(xm,ym,'j25','Color',csp);text(xm2,ym2,'j50','Color',csp);
text(xm3,ym3,'j100','Color',csp);
text(xm,-ym,'-j25','Color',csp);text(xm2,-ym2,'-j50','Color',csp);
text(xm3,-ym3,'-j100','Color',csp);
text(xm4,ym4,'j10','Color',csp);    text(xm4,-ym4,'-j10','Color',csp);
text(xm5,ym5,'j250','Color',csp);   text(xm5,-ym5,'-j250','Color',csp);   
text(0,-0.08,0,'50','Color',csp);   
text(-0.33,-0.08,'25','Color',csp);text(0.33,-0.08,'100','Color',csp);
text(-2/3, -0.08,'10','Color', csp);text(2/3, -0.08,'250','Color', csp);
%text(-1.1,0.95,'(c) 2010 D. Kajfez','Color',csp);
%axis([-1.001  1.001 -1.001 1.001]);axis('equal');
axis([-1.01  1.01 -1.01 1.01]);axis('equal');
